...
if __name__ == '__main__':
    ...
    db.names = "utf-8"
    archivo = csv.writer(open("rand1.csv", "wb"), delimiter=',')
            
    # prepare a cursor object using cursor() method
    c = db.cursor()
    #Se crea el diccionario para intercambiar las palabras        
    c.execute("select t.cuerpo,t.tipo_sentido,id_perfil from rand_fondecyt e inner join tweets t ON t.id_perfil_articulo=e.id_tweet where id_perfil=1")
